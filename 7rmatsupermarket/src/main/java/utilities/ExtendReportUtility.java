...
public class ExtendReportUtility {
	 ...
	 public static final ExtentReports extentReports = new ExtentReports(); 
	 	...
	 	public synchronized static ExtentReports createExtentReports() { //synchronized- prevent overlapping while parallel testing
	 		...
	 		extentReports.setSystemInfo("Name", "Ashitha"); //give name of team members. for more than 1 member repeat the line.
