...
public class FileUploadUtilities {
	...
	public void fileUploadUsingRobotClass(WebElement element, String filepath) throws AWTException
	{
		...
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(stringselection, null);//copy the path in a clipboard. toolkit class, the other three are methods
		Robot robot=new Robot();//robot class is used for keyboard events. keypress and release are methods. since these methods are instance we need to create class.
		robot.delay(2000);
