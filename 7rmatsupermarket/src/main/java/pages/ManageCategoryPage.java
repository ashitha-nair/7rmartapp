...
public class ManageCategoryPage {
	...
	// @FindBy(xpath="//i[@class='fas
	// fa-arrow-circle-right']//parent::a[@href='https://groceryapp.uniqassosiates.com/admin/list-category']")WebElement
	// categorymoreinfo;
	@FindBy(xpath = "//a[@class='btn btn-rounded btn-danger']")
	WebElement newbutton;
	@FindBy(xpath = "//input[@id='category']")
	WebElement category;
	@FindBy(xpath = "//div[@class='ms-selectable']//child::ul")
	WebElement selectgroups1;
	@FindBy(xpath = "//div[@class='ms-selection']//child::ul")
	WebElement selectgroups2;
	...
	/*
	 * public void clickCategoryMoreinfo() { categorymoreinfo.click(); }
	 */
