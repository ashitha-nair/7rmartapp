...
public class HomePage {
	...
	@FindBy(xpath = "//i[@class='fas fa-arrow-circle-right']//parent::a[@href='https://groceryapp.uniqassosiates.com/admin/list-category']")
	...
	@FindBy(xpath = "(//a[@class='small-box-footer']//following::i)[13]")
	WebElement morenews;
	WebDriver driver;
